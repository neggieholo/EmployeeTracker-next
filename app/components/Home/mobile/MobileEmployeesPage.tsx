...
import { Employee} from '../EmployeesDisplay';
import { MobileEmployeesDisplay } from './MobileEmployeesDisplay';
...
function EmployeesContent() {
  ...
  return (
    <div className="w-full bg-base-100 p-4 lg:p-8">
      <MobileEmployeesDisplay
        eventList={eventData}
        isLoading={isLoading}
        name={fullName}
